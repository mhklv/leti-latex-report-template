...
% Дисциплина
\renewcommand{\letiTitleSubject}{Теоретические основы электротехники}

% Тема
\renewcommand{\letiTitleTopic}{Вомбаты}

% Авторы (группа, имена)
\renewcommand{\letiTitleGroupNum}{2048}

\renewcommand{\letiTitleAuthorOne}{Корнилова\,Е.}
\renewcommand{\letiTitleAuthorTwo}{Филатов\,П.}
\renewcommand{\letiTitleAuthorThree}{}
\renewcommand{\letiTitleAuthorFour}{}


% Проверяющий (звание, имя)
\renewcommand{\letiTitleProfTitle}{Преподаватель каф. ВТ, к.т.н.}
\renewcommand{\letiTitleProfName}{Громова\,К.М.}


% Метаданные PDF
\hypersetup{%
  pdfauthor={Корнилова Е., 2048},
